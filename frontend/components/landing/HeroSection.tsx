...
export default function HeroSection({ searchTerm, onSearch, onSearchSubmit }: Props) {
  return (
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto relative shadow-2xl rounded-full">
          <div className="bg-white rounded-full p-2 flex items-center border-4 border-[#68A4F1]/30">
            ...
            <input
              type="text"
              placeholder="ค้นหาโปรเจกต์ต้นแบบ..."
            ...
            <button
              ...
              className="bg-[#2B6AD0] text-white px-8 py-3 rounded-full font-bold hover:bg-[#1F4591] transition-colors shadow-md"
            >
              ค้นหา
            </button>
          </div>
